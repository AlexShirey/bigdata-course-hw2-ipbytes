...
public class CustomMapperReducerTest {

    private MapReduceDriver<LongWritable, Text, IntWritable, BytesInfo, IntWritable, BytesInfo> mapReduceDriver;

    @Before
    public void setUp() {

        IpBytesMapper.CustomMapper mapper = new IpBytesMapper.CustomMapper();
    ...
    public void mapReduceTest() throws IOException {
        ...
        mapReduceDriver.withOutput(new IntWritable(1), new BytesInfo(20, 2));
        mapReduceDriver.withOutput(new IntWritable(2), new BytesInfo(55, 2));
